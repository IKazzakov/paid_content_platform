...
class UserModelTest(SetupTestCase):
    ...
    def test_user_created(self):
        user = User.objects.get(phone='+71234567899')
        self.assertEqual(user.phone, '+71234567899')
...
class ProfileUpdateViewTest(SetupTestCase):
    ...
    def setUp(self):
        ...
        self.client.login(username='+71234567899', password='testpass123')
    ...
    def test_profile_update_view_updates_profile(self):
        ...
        self.assertEqual(self.user.phone, '+71234567899')
